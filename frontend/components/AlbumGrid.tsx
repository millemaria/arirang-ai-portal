  ...
  return (
    <section id="albums" className="w-full py-20 px-20 flex flex-col items-center">
      <div className="w-full max-w-7xl">
        {/* Section header */}
        <div className="text-center mb-14 animate-fade-in-up flex flex-col items-center">
          <span
        ...
        {/* Album grid */}
        <div className="flex flex-wrap justify-center gap-10 mt-15 stagger-children">
